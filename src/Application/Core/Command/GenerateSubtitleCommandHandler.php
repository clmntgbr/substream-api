...
#[AsMessageHandler]
class GenerateSubtitleCommandHandler extends AbstractStreamWorkflowCommandHandler
{
    private GenerateSubtitleCommand $currentCommand;
    ...
    {
        return WorkflowTransitionEnum::GENERATING_SUBTITLE;
    }
    ...
    protected function createMessage(Stream $stream, Task $task): object
    {
        ...
        return new GenerateSubtitleMessage(
    ...
    {
        return GenerateSubtitleCommand::class;
    }
