...
use App\Core\Application\Query\FindStreamPaginatedQuery;
use App\Entity\Stream;
use Doctrine\ORM\EntityManagerInterface;
use Symfony\Component\Messenger\Attribute\AsMessageHandler;

#[AsMessageHandler]
class FindStreamPaginatedQueryHandler
{
    ...
    public function __invoke(FindStreamPaginatedQuery $query): array
    {
        $page = $query->page;
        $limit = $query->limit;
        $offset = ($page - 1) * $limit;
