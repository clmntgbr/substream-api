...
#[Route('/api/v1/streams/updatestream/', name: 'api_command_v1_stream_updatestream', methods: ['POST'])]
#[OA\Post(
    path: '/api/v1/streams/updatestream/',
...
class UpdateStreamStreamController extends \App\Shared\Presentation\Controller\BaseController
{
    ...
    public function __invoke(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $command = new \App\Core\Application\Command\UpdateStreamStreamCommand(
            );
