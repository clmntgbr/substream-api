...
use App\CoreDD\Application\Core\Message\GenerateSubtitleMessage;
use App\CoreDD\Application\Task\Command\UpdateTaskSuccessCommand;
...
class GenerateSubtitleCommandHandler
{
    ...
    public function __invoke(GenerateSubtitleCommand $command): void
    {
        ...
        try {
            ...
            $this->mercurePublisher->refreshSearchStreams($stream, GenerateSubtitleCommand::class);
        }
    }
