...
use App\CoreDD\Domain\Notification\Entity\Notification;
use App\CoreDD\Domain\Notification\Repository\NotificationRepository;
...
class CreateNotificationCommandHandler
{
    ...
    public function __invoke(CreateNotificationCommand $command): void
    {
        ...
        $this->mercurePublisher->refreshSearchNotifications($stream->getUser(), CreateNotificationCommand::class);
    }
}
