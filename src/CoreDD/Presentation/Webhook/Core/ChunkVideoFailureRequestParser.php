...
final class ChunkVideoFailureRequestParser extends AbstractRequestParser
{
    public const WEBHOOK_NAME = 'chunkvideofailure';
    ...
    protected function doParse(Request $request, #[\SensitiveParameter] string $secret): RemoteEvent
    {
        ...
        try {
            ...
            $data = $this->denormalizer->denormalize($payload->all(), ChunkVideoFailure::class);
        } catch (\Exception $e) {
