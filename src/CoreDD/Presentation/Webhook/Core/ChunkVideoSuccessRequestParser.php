...
final class ChunkVideoSuccessRequestParser extends AbstractRequestParser
{
    public const WEBHOOK_NAME = 'chunkvideosuccess';
    ...
    protected function doParse(Request $request, #[\SensitiveParameter] string $secret): RemoteEvent
    {
        ...
        try {
            ...
            $data = $this->denormalizer->denormalize($payload->all(), ChunkVideoSuccess::class);
        } catch (\Exception $e) {
