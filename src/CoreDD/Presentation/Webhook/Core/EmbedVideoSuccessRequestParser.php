...
final class EmbedVideoSuccessRequestParser extends AbstractRequestParser
{
    public const WEBHOOK_NAME = 'embedvideosuccess';
    ...
    protected function doParse(Request $request, #[\SensitiveParameter] string $secret): RemoteEvent
    {
        ...
        try {
            ...
            $data = $this->denormalizer->denormalize($payload->all(), EmbedVideoSuccess::class);
        } catch (\Exception $e) {
