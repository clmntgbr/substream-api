...
final class GenerateSubtitleFailureRequestParser extends AbstractRequestParser
{
    public const WEBHOOK_NAME = 'generatesubtitlefailure';
    ...
    protected function doParse(Request $request, #[\SensitiveParameter] string $secret): RemoteEvent
    {
        ...
        try {
            ...
            $data = $this->denormalizer->denormalize($payload->all(), GenerateSubtitleFailure::class);
        } catch (\Exception $e) {
