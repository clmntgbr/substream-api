...
final class GenerateSubtitleSuccessRequestParser extends AbstractRequestParser
{
    public const WEBHOOK_NAME = 'generatesubtitlesuccess';
    ...
    protected function doParse(Request $request, #[\SensitiveParameter] string $secret): RemoteEvent
    {
        ...
        try {
            ...
            $data = $this->denormalizer->denormalize($payload->all(), GenerateSubtitleSuccess::class);
        } catch (\Exception $e) {
