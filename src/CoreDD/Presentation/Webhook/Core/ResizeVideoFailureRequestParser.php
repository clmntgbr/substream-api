...
final class ResizeVideoFailureRequestParser extends AbstractRequestParser
{
    public const WEBHOOK_NAME = 'resizevideofailure';
    ...
    protected function doParse(Request $request, #[\SensitiveParameter] string $secret): RemoteEvent
    {
        ...
        try {
            ...
            $data = $this->denormalizer->denormalize($payload->all(), ResizeVideoFailure::class);
        } catch (\Exception $e) {
