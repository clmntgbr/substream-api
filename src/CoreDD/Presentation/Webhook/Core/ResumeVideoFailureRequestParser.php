...
final class ResumeVideoFailureRequestParser extends AbstractRequestParser
{
    public const WEBHOOK_NAME = 'resumevideofailure';
    ...
    protected function doParse(Request $request, #[\SensitiveParameter] string $secret): RemoteEvent
    {
        ...
        try {
            ...
            $data = $this->denormalizer->denormalize($payload->all(), ResumeVideoFailure::class);
        } catch (\Exception $e) {
