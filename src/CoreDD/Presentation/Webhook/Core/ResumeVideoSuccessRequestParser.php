...
final class ResumeVideoSuccessRequestParser extends AbstractRequestParser
{
    public const WEBHOOK_NAME = 'resumevideosuccess';
    ...
    protected function doParse(Request $request, #[\SensitiveParameter] string $secret): RemoteEvent
    {
        ...
        try {
            ...
            $data = $this->denormalizer->denormalize($payload->all(), ResumeVideoSuccess::class);
        } catch (\Exception $e) {
