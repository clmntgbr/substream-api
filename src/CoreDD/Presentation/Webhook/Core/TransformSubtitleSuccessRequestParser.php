...
namespace App\CoreDD\Presentation\Webhook\Core;
...
final class TransformSubtitleSuccessRequestParser extends AbstractRequestParser
{
    public const WEBHOOK_NAME = 'transformsubtitlesuccess';
    ...
    protected function doParse(Request $request, #[\SensitiveParameter] string $secret): RemoteEvent
    {
        ...
        try {
            ...
            $data = $this->denormalizer->denormalize($payload->all(), TransformSubtitleSuccess::class);
        } catch (\Exception $e) {
