...
class Stream
{
    ...
    public function updateStream(string $fileName, string $originalFileName, string $mimeType, int $size): self
    {
    ...
    public function markAsTransformedVideo(string $fileNameTransformed): self
    {
